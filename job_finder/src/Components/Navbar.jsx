            ...
            <div className="container mx-auto lg:px-6">
                    ...
                    <div className="flex flex-col gap-y-4">
                        <div className="flex items-center gap-x-2">
                            <span className=" flex items-center lg:text-5xl text-3xl">
                                <button className="rounded-full text-white bg-primary lg:text-5xl text-3xl outline-none border-none">
                                    jo
                                </button>
                ...
                {dropdown ? (
                    <div onClick={showDropdown} className="lg:hidden w-full h-[100vh] fixed top-24 bg-black ease-in-out duration-100">
                        ...
                        <ul className="taxt-center p-0 flex flex-col justify-center w-full gap-y-8">
                        ...
                        <a href="#" className="leading-normal no-underline text-white font-bold text-lg hover:text-primary">Hiring Sites</a>
