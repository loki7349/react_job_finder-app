...
function Hero(){
    return(
        <div className="bg-[#fafbfc] pt-24">
            <div className="flex flex-col items-center justify-center min-h-[60vh] py-60 px-6">
                <h1 className="xl:text-7xl lg:text-5xl sm:text-3xl text-2xl xl:leading-normal lg:leading-normal font-bold text-center">
                    Find your <span className="bg-primary text-white whitespace-pre">dream job</span> in <br /> Gurgaon
                </h1>
                <p className="text-2xl lg:w-1/2 text-center leading-10 my-8">
                    When you're serching for a job, there are a few things you can do to 
